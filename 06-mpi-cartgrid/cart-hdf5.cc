 ...
 * Written: August 2012.
 * Revised: April 2013, March 2016, March 2018, March 2020, March 2024, March 2026
 *
...
int main(int argc, char *argv[])
{
    ...
    writeFile("cart-hdf5.h5", "/grid", u, NX, NY, &orig_grid, &halo_grid,
              comm2d);
